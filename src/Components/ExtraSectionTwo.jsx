        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
          ...
          <div className="bg-white bg-opacity-90 shadow-lg rounded-lg overflow-hidden transition-transform transform hover:scale-105">
            <div className="p-6">
              ...
              <p className="text-gray-700 mb-4">
                An action role-playing game by Ubisoft Quebec. A thrilling
                journey into a world of stealth and adventure.
                <span className="block text-gray-900 font-bold mt-2">
          ...
          <div className="bg-white bg-opacity-90 shadow-lg rounded-lg overflow-hidden transition-transform transform hover:scale-105">
            <div className="p-6">
              ...
              <p className="text-gray-700 mb-4">
                Experience 15th-century Bohemia in this epic sequel by Warhorse
                Studios. Rich storytelling and breathtaking visuals await.
                <span className="block text-gray-900 font-bold mt-2">
          ...
          <div className="bg-white bg-opacity-90 shadow-lg rounded-lg overflow-hidden transition-transform transform hover:scale-105">
            <div className="p-6">
              ...
              <p className="text-gray-700 mb-4">
                A successor to Monster Hunter: World. Gear up for intense
                battles in stunning wilderness landscapes.
                <span className="block text-gray-900 font-bold mt-2">
